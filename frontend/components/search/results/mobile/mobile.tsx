...
export function Mobile({data}: Args) {
    const buttons = <>
        <div>
    ...
    return <>
        {data!.map((v, index) => {
            return <div className="p-col p-grid p-dir-col p-shadow-6" key={index}>
                <div dangerouslySetInnerHTML={{ __html: v.img }} className={`p-col ${styles.img}`} />
